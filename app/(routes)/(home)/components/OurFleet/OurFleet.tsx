...
export function OurFleet() {
    return (
        <div className="max-w-6xl mx-auto text-center py-12 lg:py-40 p-6">
            <h3 className="text-2xl lg:text-6xl font-bold">Feet Vehiculos</h3>
            <p className="text-lg mt-2 lg:mt-5 lg:text-xl text-center w-full mx-auto max-w-2xl mb-5 lg:mb-10">
                Disfruta del lujo y comodidad con nuestro alquiler de vehículos premium, dónde podrás recorrer el mundo con comodidad</p>
            <div className="grid grid-cols-2 lg:brid-cols-6 gap-4 items-center justify-center mb-5 max-w-2xl mx-auto">
