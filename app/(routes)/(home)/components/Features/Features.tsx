...
export function Features() {
    return (
        <div className="max-w-6xl mx-auto p-6 lg:py-40">
            <h3 className="text-2xl lg:text-6xl font-bold">Carácteristicas claves</h3>
            <p className="max-w-lg mt-5 lg:mb-16 text-xl">Lujosos vehículos en alquiler, experiencia inigualable y servicio premium garantizado.</p>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-5">
                {dataFeatures.map(({ icon: Icon, text, bg, delay }) => (
                    ...
                    >
                        ...
                        <p className="font-bold texte-center text-xl">{text}</p>
                    </Reveal>
                )
                )}
